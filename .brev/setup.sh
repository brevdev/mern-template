...
sudo systemctl start mongod # starting mongo locally
sudo systemctl status mongod # checking status
# to run the mongo shell, just type in "mongo" in your terminal
